...
export const portfolioProjects = [
  ...
  },
  {
    id: "macosclone",
    heading: "MacOS Clone",
    subheading: "MacOS Clone with a Website hosting!",
    description:
      "This project is a MacOS clone that mimics the look and feel of the MacOS operating system, providing a unique user experience. It features a fully functional desktop environment with a taskbar, app launcher, and various interactive elements. The project showcases advanced web development techniques using Svelte, TypeScript, and Vite, ensuring a smooth and responsive interface. Users can explore the MacOS-like environment directly in their web browsers, making it an engaging and innovative web application.",
    imageUrl: "/imgs/projects/MacOS-clone.jpg",
    techStack: [
      "Svelte",
      "TypeScript",
      "CSS",
